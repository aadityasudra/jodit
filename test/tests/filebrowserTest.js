				...
				it('Should be disable while not selected some image', function (done) {
					...
					filebrowser
						...
						.then(function () {
							...
							expect(edit.classList.contains('jodit_disabled')).to
								.be.true;
			...
			it('Should show filebrowser in default view', function (done) {
				...
				filebrowser
					...
					.then(function () {
						...
						expect(tiles.classList.contains('jodit_active')).to.be
							.true;
						expect(list.classList.contains('jodit_active')).to.be
							.false;
				...
				it('Should change filebrowser view', function (done) {
					...
					filebrowser
						...
						.then(function () {
							...
							expect(tiles.classList.contains('jodit_active')).to
								.be.true;
							expect(list.classList.contains('jodit_active')).to
								.be.false;
			...
			it('Should fire first callback in open method', function (done) {
				...
				filebrowser
					...
					.then(function () {
						...
						expect(select.classList.contains('jodit_disabled')).to
							.be.true;
